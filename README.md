...
* **Database:** SQL Server (Advanced Querying, Triggers, CTEs).

### 📂 Featured Projects
* **[Code Generator]:** A complex tool to automate SQL and UI layers.
* **[Driver License System]:** A mid-level management system with full CRUD and business logic.
